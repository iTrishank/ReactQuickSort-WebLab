    ...
    render(){
        ...
        return(
            <div className="mainAnimation">
                <h1>QuickSort partition({this.state.start},{this.state.end})</h1>
                <div>
                    <table>
                        <tbody>
                            <FlipMove
                ...
                <div>
                    <div>
                    <h2><Darrow className="pointer"/>Index traversing the array</h2>
                    <h2><Darrow className="pointer S"/>Smallest element</h2>
                    </div>
                </div>
            </div>
        );
